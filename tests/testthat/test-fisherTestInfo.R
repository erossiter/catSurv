...
test_that("fisherTestInfo calculates correctly", {
  ...
  package_fisherTI <- fisherTestInfo(ltm_cat, estimateTheta(ltm_cat))
...
test_that("fisherTestInfo calculates correctly", {
  ...
  package_fisherTI <- fisherTestInfo(grm_cat, estimateTheta(grm_cat))
...
test_that("fisherTestInfo calculates correctly", {
  ...
  package_fisherTI <- fisherTestInfo(gpcm_cat, estimateTheta(gpcm_cat))
